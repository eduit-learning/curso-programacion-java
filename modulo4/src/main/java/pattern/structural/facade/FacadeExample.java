 ...
 * excepto la inicialización de la clase controladora para la base de datos
 * requerida. El cliente simplemente interactúa con las interfaces de la fachada
 * en lugar de clases específicas de la base de datos. DriverManager actúa como
 * una fachada para el subsistema subyacente.
 * <p>
...
public class FacadeExample {
    ...
    public Connection getConnection(String driver) throws Exception {
