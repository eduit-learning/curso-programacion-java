...
public class clases {
    ...
    public static void main(String[] args) {
        ...
        Empleado e3 = new Empleado("Abraham", "Chávez Castillo", new Date(),
                "123456", "achavez@grupoeduit.com", "TI");

        Empleado e4 = new Empleado("Abraham", "Chávez Castillo", new Date(),
                "654321", "achavez@grupoeduit.com", "TI");

        System.out.println(e3.Comparar(e4));
        System.out.println(e3.Comparar(e3, e4));
    }
}
